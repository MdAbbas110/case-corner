...
return 
(
  <div className='relative mt-20 grid grid-col-1 grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
  <div
    ...
    { /* right hand side part */ }
     <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
         <ScrollArea className="relative flex-1 overflow-auto">
                 <div area-hidden="true" className="absolute z-10 inset-x-0 bottom-0
                  h-12 bg-gradient-to-t from-white pointer-events-none"/> 

                  <div className="px-8 pb-12 pt-8">
                    <h2 className="tracking-right font-bold text-3xl">
                      CUstomize your case
                    </h2>
